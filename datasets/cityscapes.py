# https://github.com/voletiv/mcvd-pytorch/blob/master/datasets/cityscapes.py
...
if __name__=='__main__':
    ...
    #path = '/home/ohishiyukito/Documents/GraduationResearch/DiffModel_with_Seg/datasets/Cityscapes64_h5/train'
    path = '/home/ohishiyukito/Documents/GraduationResearch/DiffModel_with_Seg/datasets/Cityscapes128_h5/train'
    
    # Read from dir_path which contains the HDF5_file
    h5_ds = CityscapesDataset(path)
    data = h5_ds[0]
    print(data[0].shape)
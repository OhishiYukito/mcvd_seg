# https://github.com/voletiv/mcvd-pytorch/blob/master/datasets/kth.py
...
if __name__=='__main__':
    ...
    path = '/home/ohishiyukito/Documents/GraduationResearch/DiffModel_with_Seg/datasets/KTH64_h5'
    
    # Read from dir_path which contains the HDF5_file
    h5_ds = KTHDataset(path)
    data = h5_ds[0]
    print(data[0].shape)